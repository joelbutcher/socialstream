...
import SocialstreamProviders from '@/Components/SocialstreamProviders.vue';
    ...
    <JetAuthenticationCard>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4">
                ...
                <JetInput id="password" type="password" class="mt-1 block w-full" v-model="form.password" required
